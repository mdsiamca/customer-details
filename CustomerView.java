...
public class CustomerView {
    ...
    private void initialize() {
        ...
        frmCustomerView.setTitle("Admin View");
        frmCustomerView.setBounds(100, 100, 804, 515);
        frmCustomerView.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        frmCustomerView.getContentPane().add(btnNewButton);
        ...
        frmCustomerView.getContentPane().add(btnNewButton_2);
        ...
        frmCustomerView.getContentPane().add(btnNewButton_1);
    }
}
